...
class Rubydex::Graph
  ...
  #
  # source://rubydex//lib/rubydex/graph.rb#20
  ...
  #
  # source://rubydex//lib/rubydex/graph.rb#26
  # Index all files and dependencies of the workspace that exists in `@workspace_path`
  ...
  # source://rubydex//lib/rubydex.rb#10
  sig { params(load_path: T::Array[String]).returns(T::Array[String]) }
  def require_paths(load_path); end
  ...
  # source://rubydex//lib/rubydex.rb#10
  sig { params(require_path: String, load_path: T::Array[String]).returns(T.nilable(Rubydex::Document)) }
  ...
  #
  #
  # source://rubydex//lib/rubydex/graph.rb#34
  sig { returns(T::Array[String]) }
...
class Rubydex::Namespace < ::Rubydex::Declaration
  ...
  def find_member(name, only_inherited: T.unsafe(nil)); end
