...
Command resolution is the process of receiving a hierarchy of selected tests in the UI and determining the minimum set
of shell commands required to run them. Finding the minimal amount of commands needed to execute tests is important
for performance to avoid having to spawn too many Ruby processes.
