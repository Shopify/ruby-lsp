...
class PrefixTreeTest < Minitest::Test
  def test_empty
    tree = RubyLsp::Requests::Support::PrefixTree.new([])
  ...
  def test_single_item
    tree = RubyLsp::Requests::Support::PrefixTree.new(["foo"])
  ...
  def test_multiple_items
    tree = RubyLsp::Requests::Support::PrefixTree.new(["foo", "bar", "baz"])
  ...
  def test_multiple_prefixes
    tree = RubyLsp::Requests::Support::PrefixTree.new(["fo", "foo"])
