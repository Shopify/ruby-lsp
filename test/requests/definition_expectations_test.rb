...
class DefinitionExpectationsTest < ExpectationsTestRunner
  ...
  def run_expectations(source)
    ...
    with_server(source, stub_no_typechecker: true) do |server, uri|
      ...
      graph.index_all([
        File.expand_path("../../test/fixtures/class_reference_target.rb", __dir__),
        File.expand_path("../../test/fixtures/constant_reference_target.rb", __dir__),
        File.expand_path("../../lib/ruby_lsp/server.rb", __dir__),
      ])
