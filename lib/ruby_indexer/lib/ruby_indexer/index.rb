...
module RubyIndexer
  class Index
    ...
    sig { params(method_name: String, receiver_name: String, singleton: T::Boolean).returns(T.nilable(Entry::Method)) }
    def resolve_method(method_name, receiver_name, singleton:)
