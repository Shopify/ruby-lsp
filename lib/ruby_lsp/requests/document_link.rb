  ...
  module Requests
    ...
    class DocumentLink < Request
      ...
      def initialize(uri, comments, dispatcher)
        super()
        @response_builder = ResponseBuilders::CollectionResponseBuilder[Interface::DocumentLink].new #: ResponseBuilders::CollectionResponseBuilder[Interface::DocumentLink]
