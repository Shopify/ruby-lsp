...
module RubyLsp
  module Requests
    ...
    class Formatting < Request
      ...
      def perform
        return if @global_state.formatter == "none"
      ...
      def formatted_file
        formatter_runner = @global_state.active_formatter
        raise InvalidFormatter, "No formatter available" unless formatter_runner

        formatter_runner.formatting(@uri, @document)
      end
    end
  end
end
