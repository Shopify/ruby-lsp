  ...
  module Requests
    ...
    class Completion < Request
      ...
      def initialize(document, global_state, params, sorbet_level, dispatcher)
        ...
        @response_builder = ResponseBuilders::CollectionResponseBuilder[Interface::CompletionItem].new #: ResponseBuilders::CollectionResponseBuilder[Interface::CompletionItem]
